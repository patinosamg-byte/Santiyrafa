...
// Tu configuración de Firebase actualizada (6670d)
...
function loadTimeline() {
    ...
    onSnapshot(q, (snapshot) => {
        ...
        // 1. Limpiar y poner la BIENVENIDA SIEMPRE FIJA
        container.innerHTML = `
            <article class="post welcome-card">
        ...
        // 2. Cargar los posts de Firebase
        snapshot.forEach((postDoc) => {
            ...
            const postHTML = `
                <article class="post">
                    ...
                    ${isAdmin ? `<button class="delete-btn" onclick="borrarPost('${postDoc.id}')">Eliminar</button>` : ''}
                </article>`;
    ...
    if (input.files && input.files[0]) {
        ...
        reader.onload = (e) => {
            ...
            img.onload = () => {
                ...
                preview.innerHTML = `<img src="${fotoOptimizada}">`;
